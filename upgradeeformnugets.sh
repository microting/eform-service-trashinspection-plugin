...
if (( "$GIT_STATUS" > 0 )); then
	git pull
	cd ServiceTrashInspectionPlugin

	dotnet add ServiceTrashInspectionPlugin.csproj package Microting.eForm
	dotnet add ServiceTrashInspectionPlugin.csproj package Microting.eFormTrashInspectionBase
